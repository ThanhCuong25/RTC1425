...
const Player = ({ setIsShowRightSidebar }) => {
    ...
    return (
        <div className="bg-main-400 px-5 h-full flex ">
            ...
            <div className="w-[40%] flex-auto gap-2 flex flex-col items-center justify-center py-2">
                <div className="flex gap-8 justify-center items-center">
                    ...
                    >
                        {!isLoadedSource ? <LoadingSong /> : isPlaying ? <BsFillPauseFill size={30} /> : <BsFillPlayFill size={30} />}
                    </span>
